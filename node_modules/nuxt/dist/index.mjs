...
import { findStaticImports, findExports, parseStaticImport, parseNodeModulePath, lookupNodeModuleSubpath, resolvePath as resolvePath$1, interopDefault } from 'mlly';
...
const ImportProtectionPlugin = createUnplugin(function(options) {
  ...
  const proxy = resolvePath$1("unenv/runtime/mock/proxy", { url: options.modulesDir });
  return {
